...
g.triangle_plot(roots, params, filled=[True,True,False], contouer_colors=colors, legend_colors=colors, legend_labels=[r'binned','GP','tau'], legend_loc='upper right',tight_layout=True)
